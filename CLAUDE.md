...
- **GWT v1.1 bundle synchronized to:** `organogenesis-agent-architect@2.3.0` · `reasoning-frameworks-catalog@1.2` · `substrate-evidence-guide@1.4` · `method-selection@1.2` · `agent-invocation-matrix@1.2` · `html-report-contract@1.0` · `PROJECT_SCOPE@1.3` · `causal-ablation-cascade-sim@1.0` · `squidiff-in-silico-gate@2.0.1` · **NEW** `source-of-truth/resolve_id@1.0` · `verified-identifier-store@2026-06-23.1` (**51 records**; +5 signaling/induction markers, ADR-0029) · `raw-store@1.0` (MinIO hybrid, ADR-0021) · `ingest-service@1.0` (hosted, human-gated) · `data-inamovible-graphrag@1.0` (Neo4j + OpenAI embeddings, deployed)
