# mafba sgRNA candidatos — pre-screening

**Ensembl ID:** ENSDARG00000017121
**Symbol:** mafba
**Canonical transcript:** ENSDART00000002309
**CDS length:** 1194 nt (398 codons)
...
|------|-------|--------|-----|-----------|-----|-----|-------|
| 1 | 75 | + | 212 | `GGTAAAGAAAGAGGCCATGG` | `CGG` | 50% | GC ok (50%); G at position 20; G at position 1 (good for U6) |
| 2 | 70 | + | 43 | `AACATTGCATGCGCAAAGAG` | `AGG` | 45% | GC ok (45%); G at position 20 |
| 3 | 70 | + | 45 | `CATTGCATGCGCAAAGAGAG` | `GGG` | 50% | GC ok (50%); G at position 20 |
| 4 | 70 | + | 96 | `AACACTTTGCTGAAGAACAG` | `GGG` | 40% | GC ok (40%); G at position 20 |
| 5 | 70 | - | 247 | `GCGGTTGCACTGCCGTATAT` | `TGG` | 55% | GC ok (55%); G at position 1 (good for U6) |
